...
import NavBar from '../components/nav';
  ...
  const MyOrdersPage = () => {
      ...
      const defaultEmail = 'divyanshuverma811@gmail.com';
      ...
      const fetchOrders = async () => {
          try {
              setLoading(true);
              setError('');
              const response = await axios.get('http://localhost:8080/api/v2/orders/myorders', {
      ...
      const cancelOrder = async (orderId) => {
          console.log("aa")
          try {
              const response = await axios.patch(`http://localhost:8080/api/v2/orders/cancel-order/${orderId}`);
